...
#from quiz.QuizBasket import Question
...
class Carte(Frame):
    ...
    def initUI(self):
        ...
        editmenu.add_command(label="Tout les Sports")

        editmenu.add_command(label="Football")

        editmenu.add_command(label="Basketball")

        editmenu.add_command(label="Tennis")

        editmenu.add_command(label="Natation")

        editmenu.add_command(label="Athletisme")
        ...
        helpmenu.add_command(label="Natation")

        helpmenu.add_command(label="Athlétisme")
