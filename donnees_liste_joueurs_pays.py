...
'35 Brent Rooker',
'11 Drew Waters'] }
    liste_joueurs_football_japon={"gb(gardien)":
['Masaaki Higashiguchi',	
'Eiji Kawashima',
'Daniel Schmidt'],
"df(défenseur)":['Wataru Endo',
'Tomoaki Makino',	
'Yasuyuki Konno',
'Yuto Nagatomo',	
'Gotoku Sakai',	
...
'Gen Shoji',	
'Maya Yoshida'],	
"ml(milieu de terrain)":['Yosuke Ideguchi',	
'Shinji Kagawa',	
'Takashi Inui',	
'Takefusa Kubo', 
'Makoto Hasebe',	
'Hotaru Yamaguchi'],	
"at(attaquant)":['Genki Haraguchi',	
'Takuma Asano',	
'Keisuke Honda',	
'Yuya Kubo',	
'Shinji Okazaki',	
...
"g(gardien)":["16 Steve Mandada",
"1	Alphonse Areola",	
"23	Mike Maignan"],	
"d(défenseur)":["2	Benjamin Pavard",	
"21	Léo Dubois",	
"4	Raphaël Varane", 
"3	Presnel Kimpembe",	
"5	Clément Lenglet",	
...
"19	Lucas Digne",	
"22	Benjamin Mendy"],	
"m(milieu de terrain)":["17	Moussa Sissoko",	
"13	N'Golo Kanté",	
"12	Corentin Tolisso",	
"6	Tanguy Ndombele",	
"14	Mattéo Guendouzi"],	
"at(attaquant)":["8	Thomas Lemar",	
"9	Olivier Giroud",	
"7	Antoine Griezmann",	
"10	Kylian Mbappé",	
"18	Nabil Fekir",	
